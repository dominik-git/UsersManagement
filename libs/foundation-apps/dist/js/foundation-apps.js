...
(function() {
  ...
  function zfQueryDirective(angularDirective, directiveName) {
    return ['$compile', 'FoundationApi', function ($compile, foundationApi) {
      // createPage unique scope property for media query result, must be unique to avoid collision with other zf-query directives
  ...
  function ModalFactory($http, $templateCache, $rootScope, $compile, $timeout, $q, foundationApi) {
    ...
    function modalFactory(config) {
      ...
      function checkStatus() {
        if(destroyed) {
          throw "Error: Modal was destroyed. Delete the object and createPage a new ModalFactory instance."
        }
      }
...
(function() {
  ...
  function NotificationFactory($http, $templateCache, $rootScope, $compile, $timeout, foundationApi, $sce) {
    ...
    function notificationFactory(config) {
      ...
      function checkStatus() {
        if(destroyed) {
          throw "Error: Notification Set was destroyed. Delete the object and createPage a new NotificationFactory instance."
        }
      }
