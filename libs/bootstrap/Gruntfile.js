...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      test: {
        ...
        src: 'controller/tests/unit/*.js'
      },
      assets: {
        src: ['docs/assets/controller/src/*.js', 'docs/assets/controller/*.js', '!docs/assets/controller/*.min.js']
      }
    },
    ...
    concat: {
      ...
      bootstrap: {
        src: [
          'controller/transition.js',
          'controller/alert.js',
          'controller/button.js',
          'controller/carousel.js',
          'controller/collapse.js',
          'controller/dropdown.js',
          'controller/modal.js',
          'controller/tooltip.js',
          'controller/popover.js',
          'controller/scrollspy.js',
          'controller/tab.js',
          'controller/affix.js'
        ],
        dest: 'dist/controller/<%= pkg.name %>.js'
      }
    },
    ...
    uglify: {
      ...
      core: {
        ...
        dest: 'dist/controller/<%= pkg.name %>.min.js'
      },
      customize: {
        src: configBridge.paths.customizerJs,
        dest: 'docs/assets/controller/customize.min.js'
      },
      docsJs: {
        src: configBridge.paths.docsJs,
        dest: 'docs/assets/controller/docs.min.js'
      }
    },

    qunit: {
      options: {
        inject: 'controller/tests/unit/phantom.js'
      },
    ...
    'saucelabs-qunit': {
      all: {
        options: {
          ...
          maxRetries: 3,
          maxPollRetries: 4,
          urls: ['http://127.0.0.1:3000/controller/tests/index.html'],
  ...
  grunt.registerTask('commonjs', 'Generate CommonJS entrypoint module in dist dir.', function () {
    ...
    var destFilepath = 'dist/controller/npm.js';
