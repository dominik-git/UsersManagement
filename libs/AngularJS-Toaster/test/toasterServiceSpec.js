...
describe('toasterService', function () {
	...
	it('should createPage an error method from error icon class', function () {
	...
	it('should createPage an info method from info icon class', function () {
		var container = angular.element('<toaster-container></toaster-container>');
	...
	it('should createPage an wait method from wait icon class', function () {
		var container = angular.element('<toaster-container></toaster-container>');
	...
	it('should createPage an success method from success icon class', function () {
		var container = angular.element('<toaster-container></toaster-container>');
	...
	it('should createPage an warning method from warning icon class', function () {
		var container = angular.element('<toaster-container></toaster-container>');
	...
	it('should createPage a method from the icon class that takes an object', function () {
		var container = angular.element('<toaster-container></toaster-container>');
