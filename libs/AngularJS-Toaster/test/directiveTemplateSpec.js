...
describe('directiveTemplate', function () {
	...
	it('should bind Attribute-restricted html', function () {
		var container = compileContainer();
	...
	it('should bind unrestricted html', function () {
		var container = compileContainer();
	...
	it('should not bind Element-only-restricted html', function () {
		var hasError = false;
		var container = compileContainer();
	...
	it('should not bind Class-only-restricted html', function () {
        var hasError = false;
		var container = compileContainer();
